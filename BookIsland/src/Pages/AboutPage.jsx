  ...
  return (
    <>
      ...
      <main className="pb-20">
        ...
        <p className="pb-6">Tanja is our front-end wizard who's very curious and not afraid to tackle challenging tasks</p>
        <p className="pb-6">Peter takes care of our design needs and goes down all existing rabbit holes in figma</p>
        <p className="pb-6">Alejandro is a great back-end specialist who seems to quietly plan all steps and is very considerate.</p>
        <p className="pb-6">Aridane is the most vocal member of the group and has great enthusiasm when it comes to figure out problems.</p>
        </div>
      </main>
