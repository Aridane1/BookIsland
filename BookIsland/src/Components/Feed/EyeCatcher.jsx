...
export const EyeCatcher = () => {
  return (
    <div>
        ...
        <span id="changeText" className="absolute top-[290px] left-[220px] w-[100px] text-center">New</span>
        <span className="absolute block w-fit top-[320px] left-[180px] text-[32px] font-bold text-light">Every week!</span>
        </div>
